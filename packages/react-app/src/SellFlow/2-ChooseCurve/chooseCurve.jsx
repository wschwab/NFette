      ...
      <div className={classes.mainContainer}>
        <div className={classes.infoBox}>
          ...
          <div className={classes.smallBox}>
            ...
            <div>Initial Price: 100</div>
            <div>ERC20 Name: MYNFETTESHARE-01</div>
            <div>ERC20 Symbol: MYNF</div>
          </div>
        </div>
        <div className={classes.graphBoxContainer}>
          <div className={classes.graphBox}>
            ...
            <input
              ...
              name="curveOption"
              value="aggressive"
              checked={state.curveShape === "aggressive"}
              onChange={handleOptionChange}
              type="radio"
              label="Select"
            />
            <Concave className={classes.svg} />
            <p className={classes.description}>Steep curve with high prices, early flattening out over supply</p>
          </div>
          <div className={classes.graphBox}>
            ...
            <input
              ...
              name="curveOption"
              value="slowAndSteady"
              checked={state.curveShape === "slowAndSteady"}
              onChange={handleOptionChange}
              type="radio"
              label="Select"
            />
            <Convex className={classes.svg} />
            <p className={classes.description}>Steady low curve with exponential growth in supply</p>
          </div>
          <div className={classes.graphBox}>
            ...
            <input
              ...
              name="curveOption"
              value="conventional"
              checked={state.curveShape === "conventional"}
              onChange={handleOptionChange}
              type="radio"
              label="Select"
            />
            <Linear className={classes.svg} />
            <p className={classes.description}>Linear predictable growth direct relationship in supply</p>
          </div>
        </div>
        <div className={classes.btnBar}>
          <button onClick={handlePrevious} className={`${classes.btnLeft} button`}>
            Back
          </button>
          <button onClick={handleNext} className={`${classes.btnRight} button`}>
            Next
          </button>
        </div>
      </div>
