  ...
  return (
    <div className={classes.root}>
      ...
      <p className={classes.subHeading}>
        Turn your collection into an Automatic Market Maker one piece at a time and gain funding upfront for your next
        idea BEFORE you make it!
      </p>
      ...
      <div className={classes.btnBar}>
        <button onClick={() => go("createNFT")} className={classes.btnRight}>
          Don't have an NFT?
        </button>
      </div>
    </div>
